...
module.exports = React.createClass({
  ...
  componentDidUpdate() { // Whatever method you put in here will
    this.setStorage();   // be called before the state is updated
  },
    ...
    return (
      <View style={styles.container}>
        ...
        <TextInput
          ...
          onSubmitEditing={() => this.addTask()} //Helper method, need anonymous syntax
        />
        <ScrollView>
